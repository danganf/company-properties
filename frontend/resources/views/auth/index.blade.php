...
<head>
    ...
    <title>Orbital Company - Auth</title>
    <!-- page css -->
...
<!-- ============================================================== -->
<section id="wrapper" class="login-register login-sidebar" style="background-image:url(../assets/auth/images/background/login-register-3.png);">
    <div class="login-box card">
        <div class="card-body">
            <form class="form-horizontal form-material" id="loginform">
                <a href="javascript:void(0)" class="text-center db">
                    <span class="phrase">Orbital <span>Experiências Digitais</span></span>
                </a>
